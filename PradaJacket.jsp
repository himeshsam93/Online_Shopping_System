...
<html>
	<head>
		<meta charset="UTF-8">
		<title>Prada Padded denim blouson jacket with shearling collar</title>
			...
			<div style="background-color:white;">
				...
				<div class="nike_title_1">
					...
					<table  border="0" width="90%" cellspacing="30" cellpadding="50" align="center">
							...
							<tr>
								<td>
									<iframe src="PradaJacketPhoto.jsp" style="border:none; width:700px; height:608px;" title="Iframe Example"></iframe>
									<br><br>
								...
								<td>
									...
									<form name="frmPurchase" action="orderInsertServlet"  method="POST">
										...
										<h1 style="text-align:center; font-size:30px;" id="headings">Men's Prada Padded denim blouson jacket with shearling collar.</h1>
										<input type="text" name="txtName" id="txtName" readonly value="Mens Prada Padded denim blouson jacket with shearling collar." style="width:250px;text-align:center" hidden>
										</label>
										<br><br>
										
										<label for="price">
										<input type="text" name="txtPrice" id="txtPrice" readonly value="28000.00" hidden>
										<p style="color:black;">Rs. 28,000</p> 
										</label>
										<br><br>
