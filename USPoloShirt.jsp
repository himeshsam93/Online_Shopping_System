...
<head>
		<meta charset="UTF-8">
		<title>US Polo Player 3 Pique Polo Shirt</title>
			...
			<div style="background-color:white;">
				...
				<div class="nike_title_1">
					...
					<table  border="0" width="90%" cellspacing="30" cellpadding="50" align="center">
							...
							<tr>
								<td>
									<iframe src="USPoloshirtPhoto.jsp" style="border:none; width:700px; height:608px;" title="Iframe Example"></iframe>
									<br><br>
								...
								<td>
									...
									<form name="frmPurchase" action="orderInsertServlet"  method="POST">
										...
										<label for="heading">
										<p style="color:black; font-size:13px; text-align:center;">Dark Sapphire Navy DHM</p>
										<h1 style="text-align:center; font-size:30px;" id="headings">Mens US Polo Player 3 Pique Polo Shirt.</h1>
										<input type="text" name="txtName" id="txtName" readonly value="Mens US Polo Player 3 Pique Polo Shirt." style="width:250px;text-align:center" hidden>
										</label>
										<br><br>
										
										<label for="price">
										<input type="text" name="txtPrice" id="txtPrice" readonly value="25000.00" hidden>
										<p style="color:black;">Rs. 25,000</p> 
										</label>
										<br><br>
										
											<label for="color">
											<p style="color:black;">Colors</p> 
											<input type="text" name="txtColor" id="txtColor" readonly value="White" style="width:200px;text-align:center" required>
											</label>
											<br><br>
											...
											Experience classic athleticism with the U.S. Polo Assn. Mens Player 3 Pique Polo Shirt, a tribute to polos heritage where the number 3 signifies strength and skill, representing the pivotal player on the team. Crafted from soft, breathable cotton pique, this shirt features distinctive branding and sporty charm. Pair with jeans for a polished yet relaxed ensemble that blends sporty heritage with modern style.

											<br><br><br>Cotton pique fabric<br>
											Ribbed collar and cuffs<br>
											2-button placket<br>
											Embroidered double horsemen logo<br>
											Number 3 embroidered on sleeve<br>
											Tricolour woven tab<br>
