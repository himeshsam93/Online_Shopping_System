...
<html>
    ...
    <form name="frmUpdateCustomer" id="frmUpdateCustomer" action="customerUpdateServlet" method="post" onsubmit="return validatePasswords()">
    
    
    	 <label for="first_name">Customer ID: </label><br>
        <input type="text" id="supplierID" name="txtCusID" readonly value="<%=id%>"><br><br>
