...
<html>
	<head>
		...
		<meta charset="UTF-8">
		<title>Nike Therma-FIT Windrunner</title>
			...
			<div style="background-color:white;">
				...
				<div class="nike_title_1">
					...
					<table  border="0" width="90%" cellspacing="30" cellpadding="50" align="center">
							...
							<tr>
								<td>
									<iframe src="NikeWindrunnerPhoto.jsp" style="border:none; width:700px; height:608px;" title="Iframe Example"></iframe>
									<br><br>
								...
								<td>
									...
									<form name="frmPurchase" action="orderInsertServlet"  method="POST">
										...
										<label for="heading">
										<p style="color:black; font-size:13px; text-align:center;">Nike Sustainable Materials</p>
										<h1 style="text-align:center; font-size:30px;" id="headings">Men's Nike Therma-FIT Windrunner.</h1>
										<input type="text" name="txtName" id="txtName" readonly value="Mens Nike Therma-FIT Windrunner" style="width:250px;text-align:center" hidden>
										</label>
										<br><br>
										...
										<br><br>
											...
											Perfect for transitional weather, this midweight puffer vest brings the warmth in a versatile, no-nonsense package. Nike Therma-FIT technology helps manage your body’s natural heat to help keep you warm in cold-weather conditions. The insulation is stitched down in a chevron design that nods to the classic Windrunner jacket. Durable woven fabric on the outer shell helps shed light rain to keep your core dry, and the smooth taffeta lining makes for easy layering.
											</p>
