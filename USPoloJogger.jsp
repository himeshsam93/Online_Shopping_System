...
<html>
	...
	<meta charset="UTF-8">
		<title>US Polo Block Flag Graphic Jogger</title>
			...
			<div style="background-color:white;">
				...
				<div class="nike_title_1">
					...
					<table  border="0" width="90%" cellspacing="30" cellpadding="50" align="center">
							...
							<tr>
								<td>
									<iframe src="USPoloJoggerPhoto.jsp" style="border:none; width:700px; height:608px;" title="Iframe Example"></iframe>
									<br><br>
								...
								<td>
									...
									<form name="frmPurchase" action="orderInsertServlet"  method="POST">
										...
										<h1 style="text-align:center; font-size:30px;" id="headings">Men's US Polo Block Flag Graphic Jogger</h1>
										<input type="text" name="txtName" id="txtName" readonly value="Mens US Polo Block Flag Graphic Jogger" style="width:250px;text-align:center" hidden>
										</label>
										<br><br>
										...
										<br><br>
											...
											U.S. Polo Assn. Mens Block Flag Graphic Joggers are crafted in a soft cotton material. Featuring a simple drawstring waist design making it the champion of style and comfort. The relaxed fit and ribbed cuffs keep things cosy and easy to wear. Finished with an authentic American sports-inspired graphics.
