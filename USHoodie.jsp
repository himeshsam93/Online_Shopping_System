...
<html>
	<head>
		...
		<meta charset="UTF-8">
		<title>US Polo Sport Zip-Through Hoodie.</title>
			...
			<div style="background-color:white;">
				...
				<div class="nike_title_1">
					...
					<table  border="0" width="90%" cellspacing="30" cellpadding="50" align="center">
							...
							<tr>
								<td>
									<iframe src="USHoodiePhoto.jsp" style="border:none; width:700px; height:608px;" title="Iframe Example"></iframe>
									<br><br>
									<p style="margin-left:140px;font-size:15px;">Scroll down to see more pictures</p>
								...
								<td>
									...
									<form name="frmPurchase" action="orderInsertServlet"  method="POST">
										...
										<h1 style="text-align:center; font-size:30px;" id="headings">Mens US Polo Sport Zip-Through Hoodie.</h1>
										<input type="text" name="txtName" id="txtName" readonly value="Mens US Polo Sport Zip-Through Hoodie." style="width:250px;text-align:center" hidden>
										</label>
										<br><br>
										
										<label for="price">
										<input type="text" name="txtPrice" id="txtPrice" readonly value="20000.00" hidden>
										<p style="color:black;">Rs. 20,000</p> 
										</label>
										<br><br>
										
											<label for="color">
											<p style="color:black;">Colors</p> 
											<input type="text" name="txtColor" id="txtColor" readonly value="Navy Blue" style="width:200px;text-align:center" required>
											</label>
											<br><br>
											...
											The U.S. Polo Assn. Mens Sport Zip through Hoodie has a branded zip puller, branded metal eyelets for the drawcord and a front kangaroo pocket. Crafted in a super soft cotton/poly blend. Complete with a small chest printed flag logo and a larger printed U.S. Polo Assn graphic on the sleeve for the USPA stamp of authenticity. This hoodie is a wardrobe staple perfect for layering all year round.
											</p>
