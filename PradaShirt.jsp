...
<html>
	<head>
		<meta charset="UTF-8">
		<title>Prada Re-Nylon shirt</title>
			...
			<div style="background-color:white;">
				...
				<div class="nike_title_1">
					...
					<table  border="0" width="90%" cellspacing="30" cellpadding="50" align="center">
							...
							<tr>
								<td>
									<iframe src="PradaShirtPhoto.jsp" style="border:none; width:700px; height:608px;" title="Iframe Example"></iframe>
									<br><br>
								...
								<td>
									...
									<form name="frmPurchase" action="orderInsertServlet"  method="POST">
										...
										<label for="heading">
										<p style="color:black; font-size:13px; text-align:center;">Sea Beyond</p>
										<h1 style="text-align:center; font-size:30px;" id="headings">Men's Prada Re-Nylon shirt.</h1>
										<input type="text" name="txtName" id="txtName" readonly value="Mens Prada Re-Nylon shirt." style="width:250px;text-align:center" hidden>
										</label>
										<br><br>
										
										<label for="price">
										<input type="text" name="txtPrice" id="txtPrice" readonly value="35000.00" hidden>
										<p style="color:black;">Rs. 35,000</p> 
										</label>
										<br><br>
										
											<label for="color">
											<p style="color:black;">Colors</p> 
											<input type="text" name="txtColor" id="txtColor" readonly value="Black" style="width:200px;text-align:center" required>
											</label>
											<br><br>
											...
											<br><br><br>
											<p style="font-size:15px;"><b>Description : </b><br><br>
											<b>SEA BEYOND</b><br><br>
											SEA BEYOND is the educational program launched in 2019 by Prada Group and UNESCO’s Intergovernmental Oceanographic Commission (IOC). to raise awareness on sustainability and ocean preservation.

											As of July 2023, the SEA BEYOND project is supported by 1% of the proceeds from the Prada Re-Nylon Collection, to continuously strengthen the partnership between the Prada Group and IOC/UNESCO.
