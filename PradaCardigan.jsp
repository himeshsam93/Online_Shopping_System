...
<html>
	<head>
		<meta charset="UTF-8">
		<title>Prada Cashmere Cardigan</title>
			...
			<div style="background-color:white;">
				...
				<div class="nike_title_1">
					...
					<table  border="0" width="90%" cellspacing="30" cellpadding="50" align="center">
							...
							<tr>
								<td>
									<iframe src="PradaCardiganPhoto.jsp" style="border:none; width:700px; height:608px;" title="Iframe Example"></iframe>
									<br><br>
								...
								<td>
									...
									<form name="frmPurchase" action="orderInsertServlet"  method="POST">
										...
										<label for="heading">
										<p style="color:black; font-size:13px; text-align:center;">Wool Knitwear</p>
										<h1 style="text-align:center; font-size:30px;" id="headings">Men's Prada Cashmere Cardigan.</h1>
										<input type="text" name="txtName" id="txtName" readonly value="Mens Prada Cashmere Cardigan." style="width:250px;text-align:center" hidden>
										</label>
										<br><br>
										...
										<br><br>
											...
											<input type="text" name="txtColor" id="txtColor" readonly value="Desert Beige" style="width:200px;text-align:center" required>
											</label>
											<br><br>
