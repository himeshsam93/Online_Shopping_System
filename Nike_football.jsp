...
<html>
	<head>
		...
		<meta charset="UTF-8">
		<title>Nike Authentic Football T-shirt</title>
			...
			<div style="background-color:white;">
				...
				<div class="nike_title_1">
					...
					<table  border="0" width="90%" cellspacing="30" cellpadding="50" align="center">
							...
							<tr>
								<td>
									<iframe src="NikeFootballPhoto.jsp" style="border:none; width:700px; height:608px;" title="Iframe Example"></iframe>
									<br><br>
								...
								<td>
									...
									<form name="frmPurchase" action="orderInsertServlet"  method="POST">
										...
										<label for="heading">
										<p style="color:black; font-size:13px; text-align:center;">F.C. Barcelona 2024/25 Match Home</p>
										<h1 style="text-align:center; font-size:30px;" id="headings">Men's Nike Football Authentic Shirt.</h1>
										<input type="text" name="txtName" id="txtName" readonly value="Mens Nike Football Authentic Shirt" style="width:250px;text-align:center" hidden>
										</label>
										<br><br>
										
										<label for="price">
										<input type="text" name="txtPrice" id="txtPrice" readonly value="12000.00" hidden>
										<p style="color:black;">Rs. 12,000</p> 
										</label>
										<br><br>
										
											<label for="color">
											<p style="color:black;">Colors</p> 
											<input type="text" name="txtColor" id="txtColor" readonly value="Deep Royal Blue" style="width:200px;text-align:center" required>
											</label>
											<br><br>
